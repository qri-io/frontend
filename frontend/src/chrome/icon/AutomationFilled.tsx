...
const AutomationFilled: React.FC<CustomIconProps> = (props) => (
  <CustomIcon {...props}>
    ...
    <path d="M12.0001 7.33336V12M12.0001 12H7.66675C7.11446 12 6.66675 12.4477 6.66675 13V16.6667M12.0001 12H16.3334C16.8857 12 17.3334 12.4477 17.3334 13V16.6667" stroke="currentColor" stroke-linecap="round"/>
  </CustomIcon>
)
