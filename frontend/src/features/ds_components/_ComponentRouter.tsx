...
import CommitEditor from './datasetComponents/_CommitEditor'
import Commit from './datasetComponents/Commit'
import DropZone from '../chrome/DropZone'
import Icon from '../../chrome/Icon'
import Metadata from './datasetComponents/Meta'
import MetadataEditor from './datasetComponents/_MetadataEditor'
import ReadmeEditor from './datasetComponents/_ReadmeEditor'
import Readme from './datasetComponents/Readme'
import Structure from '../Structure'
import Transform from './datasetComponents/Transform'
import StructureEditor from './datasetComponents/_StructureEditor'
