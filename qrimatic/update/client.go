...
// Workflow aliases a scheduler.Workflow, removing the need to import the scheduler package.
type Workflow = scheduler.Workflow

// Run aliases a scheduler.Run, removing the need to import the scheduler package.
...
func (c *Client) List(ctx context.Context, p *lib.ListParams, jobs *[]*Workflow) error {
...
// Workflow gets a job by name
func (c *Client) Workflow(ctx context.Context, name *string, job *Workflow) error {
...
// 	// these are needed because lib.NewInstance creates a scheduler client
