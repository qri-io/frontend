...
const Dataset: React.FC<CustomIconProps> = (props) => (
  <CustomIcon {...props}>
    <path d="M12 8C16.9706 8 21 6.65686 21 5C21 3.34314 16.9706 2 12 2C7.02944 2 3 3.34314 3 5C3 6.65686 7.02944 8 12 8Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
