...
const Schema: React.FC<SchemaProps> = ({
  ...
  const thClassName = 'h-6 bg-white font-medium text-left p-0 p-0 border-t border-r border-b border-qrigray-200 text-black capitalize text-sm'

  return (
    <div className='overflow-x-scroll'>
      <table className='table text-xs border-separate border-l border-qrigray-200 w-full tracking-wider break-words' style={{ borderSpacing: 0 }}>
        <thead>
